...
ConnectionContext::ConnectionContext(std::shared_ptr<uvw::TCPHandle> tcpHandle, ObfsClass *obfsClassPtr, CipherEnv *cipherEnvPtr):
    ...
    localBuf{new Buffer},
    protocolPtr{nullptr,obfsClassPtr->protocol_plugin->dispose},
    obfsPtr{nullptr,obfsClassPtr->obfs_plugin->dispose},
...
ConnectionContext::ConnectionContext():
    ...
    e_ctx{nullptr,dummyDisposeEncCtx},d_ctx{nullptr,dummyDisposeEncCtx}
{}
